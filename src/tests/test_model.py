...
class ModelEvulation:
    def __init__(self,test_data_path,model_path,report_path):
    ...
    def evulate_model(self):
        ...
        test_score=cross_val_score(self.model,x_test,y_pred,cv=5,scoring="r2").mean()
...
if __name__=="__main__":
    evulation=ModelEvulation(test_data_path='data/processed/test.npy',model_path="Models/model.pkl",
